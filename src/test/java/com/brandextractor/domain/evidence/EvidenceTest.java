...
class EvidenceTest {
    ...
    void colorEvidence_holdsHexAndFrequency() {
        var evidence = new ColorEvidence("color-1", "CSS", "styles.css", "#0F172A", 0.42);
    ...
    void ocrEvidence_holdsTextBlocks() {
        var evidence = new OcrEvidence("ocr-1", "IMAGE", "flyer.png", List.of("ACME", "Studio"));
    ...
    void sealedInterface_patternMatch_exhaustive() {
        Evidence e = new TextEvidence("t-1", "HTML", "index.html", "Acme Studio", "heading");
